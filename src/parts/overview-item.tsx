...
function OverviewItem(props: any) {
    return (
        <section className="bg-white dark:bg-gray-800 container mx-auto p-6">
            <h2 className="text-gray-800 dark:text-white font-medium capitalize text-xl md:text-2xl">Our Team</h2>

            <div className="flex items-center justify-center">
                <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-8">
                    <div className="max-w-xs w-full text-center">
                        <img className="h-48 w-full object-cover object-center mx-auto rounded-lg"
